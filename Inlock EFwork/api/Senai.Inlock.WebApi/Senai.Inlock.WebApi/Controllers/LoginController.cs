...
namespace Senai.Inlock.WebApi.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Autenticar(Usuarios usuarios)
        {
            Usuarios domain = banco.Comparar(usuarios.Email, usuarios.Senha);
            if (domain != null)
            {
                var claims = new[]
                {
                   ...
                   new Claim(ClaimTypes.Role, domain.IdTipoUsuario.ToString())
               };
